  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-[var(--bg)]">
      ...
      <div
        ...
        style={{ fontSize: '10px', color: '#1F2937', bottom: 'max(20px, calc(8px + env(safe-area-inset-bottom, 0px)))' }}
      >
      ...
      <div
        ...
        style={{ fontSize: '10px', color: '#1F2937', bottom: 'max(40px, calc(28px + env(safe-area-inset-bottom, 0px)))' }}
      >
        © 2026 MB Consulting
      </div>
