      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          ...
          <Select value={form.category} onValueChange={(v) => set("category", v)}>
            ...
            <SelectContent>
              {["Restaurant", "Pizzerie", "Bar e Pub", "Hotel", "B&B", "Beni Culturali", "Itinerari", "Monumenti", "Musei", "Spiagge", "Bandiera Blu", "Bandiera Verde", "Sea Park", "Archeologia", "Discoteche", "Supermercati", "Shop", "Pharmacy", "Bancomat", "Bar e Pasticcerie"].map((c) => <SelectItem key={c} value={c}>{c}</SelectItem>)}
            </SelectContent>
          </Select>
        </div>
      </div>
